...
public class MeteredActionBarActivity extends ActionBarActivity{
	...
	/** user_id -- the unique device model that is referred as the user id.*/
    ...
    /**
     * Resume the QoE service by creating an intent parameter and bind the activity to the right service
     */
    ...
    protected void registerApplication(String application){
		...
		this.model_name=Build.MANUFACTURER+" "+ Build.MODEL;
		Log.d("com.bth.qoe", "device is:"+this.model_name);
